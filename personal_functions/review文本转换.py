...
@CatchException
def review文本转换(txt, llm_kwargs, plugin_kwargs, chatbot, history, system_prompt, web_port):
    """
    ...
    i_say = r"As an English native speaker and professor in the field of computer vision, your task is to play a role of a senior reviewer and polish a mixed Chinese and English draft review into correct and precise English. Your output should be clear, concise, accurate, and follow the Nature/CVPR style guidelines while still preserving the original meaning of the sentences in the draft review. Please note that you must use present tense throughout your translation. Additionally, please feel free to incorporate creative wordings and sentences as needed for clarity or accuracy. Your response should also adhere to any relevant conventions associated with the Nature/CVPR style guidelines such as sentence structure, formatting, grammar rules, etc., so that it accurately reflects the scientific nature of the paper."
    gpt_say = r"Sure, I'm happy to help! Please provide me with the draft review."
